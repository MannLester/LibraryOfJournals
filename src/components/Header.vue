  ...
  <header class="header-container" :class="{ 'logged-in-header': isAuthenticated }">
    <div class="header-content">
      ...
      <div class="center-nav" v-if="isAuthenticated">
        <a href="#" class="center-nav-item" :class="{ 'active': activeNavItem === 'home' }" @click.prevent="setActiveNavItem('home')">
        ...
        <a href="#" class="center-nav-item" :class="{ 'active': activeNavItem === 'library' }" @click.prevent="setActiveNavItem('library')">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="nav-icon" viewBox="0 0 16 16">
            <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.777.416L8 13.101l-5.223 2.815A.5.5 0 0 1 2 15.5V2zm2-1a1 1 0 0 0-1 1v12.566l4.723-2.482a.5.5 0 0 1 .554 0L13 14.566V2a1 1 0 0 0-1-1H4z"/>
          </svg>
          My Library
        </a>
        <a href="#" class="center-nav-item" :class="{ 'active': activeNavItem === 'explore' }" @click.prevent="setActiveNavItem('explore')">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="nav-icon" viewBox="0 0 16 16">
        ...
        <a href="#" class="center-nav-item" :class="{ 'active': activeNavItem === 'settings' }" @click.prevent="setActiveNavItem('settings')">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="nav-icon" viewBox="0 0 16 16">
